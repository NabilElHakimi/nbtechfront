        ...
        <>
            <div className="w-full h-screen flex justify-center items-center p-4">
                <form className="bg-white p-6 sm:p-8 md:p-10 rounded-md shadow-md w-full sm:w-[80%] md:w-[30%] lg:w-[30%]">
                    ...
                    <h1 className="text-2xl sm:text-2xl font-bold mb-4 text-blue-800 text-center">Connexion</h1>
                    <div className="mb-4">
                    ...
                    <div className="flex flex-col gap-2">
                        ...
                        <Link
                            className="bg-green-500 hover:bg-green-700 text-white font-bold py-2 px-2 rounded focus:outline-none focus:shadow-outline text-center"
                            type="button"
                            to={"/register"}
                        >
                            S'inscrire
